...
# Builder 成果包交接（SPEC-DB-001 §10/§11，PLAN-DB-001 Task 10）
HANDOFF_CODES = {
    "HANDOFF_ID_CONFLICT",
    "HANDOFF_INVALID",
}

ALL_KNOWN_CODES = APPLICATION_CODES | CAD_CODES | SETTINGS_CODES | SHELL_CODES | EXTENSION_CODES | HANDOFF_CODES
