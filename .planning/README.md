...
- [标准整数版本、按 ID 归集与标准包预检导入实施计划（PLAN-DM-041，proposed）](plans/dst-manager/PLAN-DM-041-standard-package-import-picker.md)：在 PLAN-DM-040 共享代码收敛后实施整数版本、标准库归集与 `.dststandard` 两步预检导入，保留原 F16 的原生选择任务。
