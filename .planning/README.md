...
- [DST Builder 路线图](roadmaps/dst-builder.md)
...
- [DST Builder 整体归档与文档封口实施计划（PLAN-INT-004，proposed）](plans/integration/PLAN-INT-004-retire-dst-builder.md)：将 Builder 产品面和专用脚本整体移入本地 `legacy/`，删除 0007/0008 并压平未发布的 Manager 迁移基线，保留历史文档并收口单产品治理。
