...
- [Builtin 扩展全局设置框架实施计划（PLAN-DM-025，proposed；已按 MEMO-DM-033 关闭 2 个阻断项并补齐实施边界，共 9 项任务；前端 generated/custom 实施前须重开并通过 SPEC-DM-011 G4）](PLAN-DM-025-extension-global-settings.md)
