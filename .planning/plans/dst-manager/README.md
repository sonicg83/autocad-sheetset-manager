...
- [图纸标准平台欢迎页与编辑器视觉收口实施计划（PLAN-DM-039，proposed）](PLAN-DM-039-standard-platform-ui-visual-closure.md)：承接 PLAN-DM-035/038 已接通功能但遗漏的页面级布局与视觉证据——重建“打开 DST 优先”的欢迎页约 2:1 双栏，把标准草稿切换为独立全宽编辑工作台，并以候选截图、Demo 人工裁决、新 G4/G8 和真实 WebView2 100/125/150/200% 检查作为关闭条件；不修改标准 Schema、后端 API 或 PLAN-DM-036 创建流程。
