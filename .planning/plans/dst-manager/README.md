...
- [标准整数版本、按 ID 归集与标准包预检导入实施计划（PLAN-DM-041，proposed）](PLAN-DM-041-standard-package-import-picker.md)：承接原 F16，并在 PLAN-DM-040 共享代码收敛后实施服务端整数版本、按 ID 归集、两步预检导入及 G9 验收。
