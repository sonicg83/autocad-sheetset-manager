...
| v0.3.3 | 已完成 | 桌面界面人性化与易用性重构：依据 SPEC-DM-006 落地（令牌化双主题、统一组件、三区外壳、ActionDock 与无障碍验收），并处理 v0.3.1 其余遗留项（M1-M5、M7、T 系列） | [PLAN-DM-013](../plans/dst-manager/PLAN-DM-013-v033-tabbed-shell.md)，依据 [SPEC-DM-006](../../docs/dst-manager/specs/SPEC-DM-006-dst-manager-desktop-ui-ux.md) |
