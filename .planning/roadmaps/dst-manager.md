...
| v0.3.1 | 计划中 | 桌面壳（WebView2）与操作易用性迭代：壳为唯一入口、DST 文件选择/关闭确认、草稿恢复可发现性、来源文件与布局选择、布局缓存 | 实施计划待编制，依据 [SPEC-DM-007](../../docs/dst-manager/specs/SPEC-DM-007-v031-shell-and-usability.md) |
