...
DST Builder 曾是面向图纸集首版生产的本地桌面应用。[RFC-INT-003](../integration/rfcs/RFC-INT-003-retire-builder-standard-driven-sheetset-creation.md) 已于 2026-09-21 接受其直接退场及标准驱动创建归入 DST Manager 的方向；本目录自该决策起作为待实施退场的历史入口，不再接收新的 Builder 产品需求。
