...
| `g4-03-properties-light-1440x900.png` | 编辑器·属性定义（三条属性，含枚举与图幅） |
| `g4-04-mapping-light-1440x900.png` | 字段映射（一条映射规则 + 三行专业映射） |
| `g4-05-composition-light-1440x900.png` | 字段组合派生与 DWG 命名（片段 + 示例结果） |
...
| `g4-12-mapping-narrow-light-900x768.png` | 补充：字段映射 900×768 窄视口（无横向溢出） |
