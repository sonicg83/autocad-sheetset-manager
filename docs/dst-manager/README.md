...
- [图纸目录 XLSX 内置扩展设计规范（SPEC-DM-012，已接受；G0～G6 已通过，G7 正确性收口 PLAN-DM-024，G8 视觉整改 PLAN-DM-023，G9 暂停）](specs/SPEC-DM-012-sheet-catalog-extension.md)
