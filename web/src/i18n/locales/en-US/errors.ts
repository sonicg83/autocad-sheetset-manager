...
export default {
  ...
  // Standard-driven creation (PLAN-DM-036 Task 4/6); keys mirror the CREATION_* codes,
  // and the `diagnostic` sub-domain mirrors the creation diagnostic codes
  creation: {
    ...
    previewStale: "The creation preview has changed or was not confirmed. Preview again before executing",
    planInvalid: "The creation plan has blocking issues and cannot run; fix the diagnostics and preview again",
    jobIdInvalid: "The creation job identity is invalid and cannot run",
    attemptInvalid: "The creation job attempt number is invalid and cannot run",
    assetPathInvalid: "A standard asset path is invalid; check the asset declarations of the standard",
    assetFileMissing: "A template file declared by the standard does not exist; publish the standard again or fix the asset path",
    layoutTemplateMismatch: "The layout template does not contain the paper size declared by the standard; fix the template or the declaration",
    layoutSetMismatch: "The generated master DWG layouts do not match the plan; nothing was produced by this creation",
    layoutReadFailed: "Failed to read layouts; the DWG may be in use or the CAD environment may be unavailable",
    layoutReferenceInvalid: "A sheet layout reference is invalid; nothing was produced by this creation",
    handleInvalid: "A layout handle is invalid; nothing was produced by this creation",
    handlePlaceholder: "Some sheets still have no real layout handle; nothing was produced by this creation",
    handleDuplicate: "Duplicate handles were found in the same DWG; nothing was produced by this creation",
    handleSetMismatch: "Read-back handles do not match the plan; nothing was produced by this creation",
    roundtripMismatch: "The generated DST does not survive the encode round trip as planned; nothing was produced by this creation",
    dstInvalid: "The generated DST failed contract/semantic validation; nothing was produced by this creation",
    skeletonInvalid: "The built-in DST skeleton could not be instantiated; upgrade the Manager and retry",
    skeletonUnreadable: "The built-in DST skeleton is unreadable; reinstall or repair the Manager",
    cadUnavailable: "AutoCAD has no Core Console or Worker plugin configured; run dst-manager doctor",
    cadFailed: "CAD execution failed; check the per-DWG logs before retrying",
    publishInvalid: "The candidate result does not match the job identity, or a file is invalid; the target folder was not written",
