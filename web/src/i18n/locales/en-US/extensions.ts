...
export default {
  sheetCatalog: {
    ...
    columnCount: "{count} / {limit} columns",
    columnsHeadOrder: "Order",
    columnsHeadHeader: "Column header",
    columnsHeadExpression: "Expression",
    columnsHeadStatus: "Status",
    ...
    compatBadgeExecutable: "Ready to export",
    compatBadgeWarning: "Ready to export, {count} warning(s)",
    compatBadgeChecking: "Checking",
    compatBadgeBlocked: "Cannot export",
    previewLabel: "Preview",
    previewTotal: "{total} sheets in total",
    previewTotalFiltered: "{total} sheets output",
    previewFiltered: "{count} sheet(s) filtered out",
    ...
    previewContractInvalid: "The preview response is missing its settings revision binding, so this preview was not used; refresh the preview to retry.",
    actionsLabel: "Export actions",
    refreshPreview: "Refresh preview",
    exportButton: "Export XLSX",
    exporting: "Exporting…",
    exportConsistentHint: "The preview matches the current draft and workspace revision",
    ...
    settingsGroupTemplate: "Template settings",
    settingsGroupOutput: "Output",
    settingsFilterLabel: "Output sheet filter",
